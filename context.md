# TCG Blueprint — Context

See [VISION.md](docs/VISION.md) for the full north star.

Version specs live in `docs/versions/`.
...
| v0.4    | docs/versions/v0.4.md   | 🗂 Planning  | Unit keywords                  |
